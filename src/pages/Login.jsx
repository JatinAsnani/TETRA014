...
export default function Login() {
  const [email, setEmail] = useState('admin@sharmastore.com');
  ...
  function validateAndLogin(e) {
    ...
    if (!password || password.length < 6) {
      setCatVideo('/cat_wrong.mp4');
      setBubbleText('Wrong Password! 😿 (Min 6 chars)');
      setIsError(true);
      return;
    }

    // Special wrong password demo check
    if (password === 'wrong' || password === '12345' || password === '123456') {
      setCatVideo('/cat_wrong.mp4');
